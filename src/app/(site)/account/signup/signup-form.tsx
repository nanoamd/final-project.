...
/** `next` is already sanitised by the page — see `safeNextPath`. */
    ...
    return (
      <Container width="narrow" className="py-20 md:py-28">
        ...
        <p className="text-muted mt-6 max-w-sm text-[15px] leading-relaxed">
          ...
          {next === "/cart"
            ? " Your basket will still be here — it is saved in this browser."
            : null}
        </p>
      </Container>
    );
    ...
    <Container width="narrow" className="py-20 md:py-28">
      ...
      {next === "/cart" ? (
        <p className="text-graphite mt-5 max-w-sm text-[15px] leading-relaxed">
          ...
          your paperwork later. Create one to finish checking out — your basket
          is waiting.
        </p>
      ) : null}
      ...
      <p className="text-muted mt-8 text-[14px]">
        ...
        <AppLink href={loginHref} className="text-brass">
          Sign in
        </AppLink>
      </p>
    </Container>
