  ...
  return (
    <section className="bg-basalt">
      <div className="mx-auto max-w-3xl px-6 py-10 text-center sm:px-8 sm:py-20 lg:py-28">
        <p className="text-canvas/50 mb-5 text-[11px] font-medium tracking-[0.24em] uppercase sm:mb-6">
          Why We Exist
        </p>
        <h2 className="text-canvas font-display text-[1.7rem] leading-[1.25] tracking-tight text-balance sm:text-3xl lg:text-4xl">
          Most home goods are sold on a lifestyle photo. We&rsquo;d rather show
          you the actual specification.
        </h2>
        <p className="text-canvas/60 mt-6 text-[15px] leading-relaxed sm:text-base">
